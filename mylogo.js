        ...
        function processCode(code) {
          ...
          setTimeout(function() {
            ...
            if(settings.grey_skull || settings.tball || settings.custom_url) {
              const normal = {
                tball:    i('https://i.ibb.co/q9bwLf6/fetch-The-da-Ta.png'),
              ...
              const dead = {
                tball:    i('https://i.ibb.co/x68Mcyy/164194740870211755.png'),
              ...
              // eval(`var tball_ = new Image(); tball_.src = 'https://i.ibb.co/q9bwLf6/fetch-The-da-Ta.png';`);
              // eval(
              //   code.match(
              ...
              //         return document.querySelector('#apple').getElementsByClassName('DqMRee tuJOWd')[0].src.includes('fetch-The-da-Ta.png') 
              //           ? tball_ 
