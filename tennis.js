          ...
          setTimeout(function() {
            ...
            if(settings.grey_skull || settings.tball || settings.custom_url) {
              ...
              setTimeout(_ => {
                ...
                settings.tball     && (window.darks.push(dead.burg),    document.querySelector('#apple').appendChild(normal.burg));
              ...
              // eval(`var bu_ = new Image(); tball_.src = 'https://i.ibb.co/QHDbWrn/ezgif-3-5122a424f32f.png';`);
              // eval(
              //   code.match(
              ...
              //         return document.querySelector('#apple').getElementsByClassName('DqMRee tuJOWd')[0].src.includes('ezgif-3-5122a424f32f.png') 
              //           ? tball_ 
