if(window.snake) {
        ...
        function processCode(code) {
          ...
          setTimeout(function() {
            ...
            if(settings.grey_skull || settings.tball || settings.custom_url) {
              const normal = {
                tball:    i('https://i.ibb.co/9V4Hdrd/ezgif-3-e680df6cb421.png'),
              ...
              const dead = {
                tball:    i('https://i.ibb.co/y0TmLnT/11111164194740870211755.png'),
              ...
              // eval(`var tball_ = new Image(); tball_.src = 'https://i.ibb.co/9V4Hdrd/ezgif-3-e680df6cb421.png';`);
              // eval(
              //   code.match(
              ...
              //         return document.querySelector('#apple').getElementsByClassName('DqMRee tuJOWd')[0].src.includes('ezgif-3-e680df6cb421.png') 
              //           ? tball_ 
  ...
  window.snake.football = function() {
    return window.snake.scheme({
      ...
      dark_ee:         '#1b6e31',
      buttons:         '#522522', 
  snaket:  [ '#825736', '#dbdbdb', ],
      tsnake:  [ '#dbdbdb', '#825736', ],
      tball:            true,
    });
  };
