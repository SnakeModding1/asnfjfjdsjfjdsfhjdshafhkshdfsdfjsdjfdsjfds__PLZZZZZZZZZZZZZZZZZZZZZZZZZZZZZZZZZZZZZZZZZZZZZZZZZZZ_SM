if(window.snake) {
        ...
        function processCode(code) {
          ...
          setTimeout(function() {
            ...
            if(settings.grey_skull || settings.tball || settings.custom_url) {
              const normal = {
                tball:    i('https://i.ibb.co/ZhZ58DN/163527981571331652-1.png'),
                skull:   i('https://www.google.com/logos/fnbx/snake_arcade/v4/apple_00.png')
              };
              if(settings.custom_url)normal.custom = i(settings.custom_url);
              ...
              // eval(`var tball_ = new Image(); tball_.src = 'https://i.ibb.co/ZhZ58DN/163527981571331652-1.png';`);
              // eval(
              //   code.match(
              ...
              //         return document.querySelector('#apple').getElementsByClassName('DqMRee tuJOWd')[0].src.includes('163527981571331652-1.png') 
              //           ? tball_ 
  ...
  window.snake.candy = function() {
    return window.snake.scheme({
      ...
      dark_ee:         '#381f07',
      buttons:         '#633405', 
  snaket:  [ '#2e1a06', '#4a2908', ],
      tsnake:  [ '#4a2908', '#2e1a06', ],
      tball:            true,
    });
  };
  ...
  window.snake.checkers = function() {
    return window.snake.scheme({
      ...
      dark_ee:         '#000000',
      buttons:         '#ff2b2b', 
  snaket:  [ '#a60f0f', '#1f1e1e', ],
      tsnake:  [ '#1f1e1e', '#a60f0f', ],
      tball:            true,
      ball:            true,
    });
  };
