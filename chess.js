if(window.snake) {
      ...
      setTimeout(_ => {
        ...
        function processCode(code) {
          ...
          setTimeout(function() {
            ...
            settings.snaket = settings.snaket || [ '#000000', '#000000', ];
            settings.tsnake  = settings.tsnake  || [ '#000000', '#000000', ];
            ...
            if(settings.grey_skull || settings.tball || settings.custom_url) {
              const normal = {
                tball:    i('https://i.ibb.co/gTd62rT/3506749-HSC00001-7-removebg-preview.png'),
              ...
              const dead = {
                tball:    i('https://i.ibb.co/2yLQBdJ/1164194740870211755.png'),
              ...
              // eval(`var tball_ = new Image(); tball_.src = 'https://i.ibb.co/gTd62rT/3506749-HSC00001-7-removebg-preview.png';`);
              // eval(
              //   code.match(
              ...
              //         return document.querySelector('#apple').getElementsByClassName('DqMRee tuJOWd')[0].src.includes('3506749-HSC00001-7-removebg-preview.png') 
              //           ? tball_ 
  ...
  window.snake.chess = function() {
    return window.snake.scheme({
      ...
      dark_ee:         '#000000',
      buttons:         '#cf7725', 
  snaket:  [ '#b5702f', '#261e16', ],
      tsnake:  [ '#261e16', '#b5702f', ],
      tball:            true,
    });
  };
